                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblPrice" runat="server" Text='<%# string.IsNullOrEmpty( Eval("Price").ToString() ) ? "" : Eval("Price") %>'></asp:Label> Total :
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                                    </td>
                                                                    <td><asp:Label ID="lblTotalPrice" runat="server" Text='<%# Eval("TotalPrice") %>'></asp:Label> (MMK)
                                                                    </td>
                                                                    <td>
