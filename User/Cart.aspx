            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand"
                ...
                <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td><asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label> (MMK)
                        ...
                        <td><asp:Label ID="lblTotalPrice" runat="server"> (MMK)</asp:Label>
                        </td>
                        <td>
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td>
                            <b><% Response.Write(Session["grndTotalPrice"]); %> (MMK)</b>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
